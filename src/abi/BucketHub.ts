const abi = [
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "bytes", name: "primarySpSignature", type: "bytes" },
          { internalType: "uint64", name: "chargedReadQuota", type: "uint64" },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256", name: "remainingGas", type: "uint256" },
      { internalType: "address", name: "refundAddress", type: "address" },
    ],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "address", name: "_ERC721_token", type: "address" },
      { internalType: "address", name: "_additional", type: "address" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "bytes", name: "callbackData", type: "bytes" },
      { internalType: "bytes", name: "failReason", type: "bytes" },
    ],
    stateMutability: "view",
    type: "function",
  },
